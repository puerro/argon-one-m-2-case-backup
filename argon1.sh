...
then
	...
	sudo wget https://raw.githubusercontent.com/puerro/argon-one-m-2-case-backup/main/ar1config.png -O /usr/share/pixmaps/ar1config.png --quiet
	sudo wget https://raw.githubusercontent.com/puerro/argon-one-m-2-case-backup/main/ar1uninstall.png -O /usr/share/pixmaps/ar1uninstall.png --quiet
	# Create Shortcuts
...
# IR config script
sudo wget https://raw.githubusercontent.com/puerro/argon-one-m-2-case-backup/main/argonone-irconfig.sh -O /usr/bin/argonone-ir --quiet
